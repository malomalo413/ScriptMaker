const CACHE_NAME = 'scriptmaker-editor-v12';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=28','../js/firebase-config.js?v=1','../js/firebase-share.js?v=1','../js/app.js?v=28','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
