const CACHE_NAME = 'scriptmaker-editor-v7';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=23','../js/app.js?v=23','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
