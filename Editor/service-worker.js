const CACHE_NAME = 'scriptmaker-editor-v24';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=36','../js/firebase-config.js?v=30','../js/firebase-share.js?v=31','../js/app.js?v=39','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
