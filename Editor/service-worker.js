const CACHE_NAME = 'scriptmaker-editor-v42';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=48','../js/firebase-config.js?v=30','../js/firebase-share.js?v=35','../js/app.js?v=56','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
