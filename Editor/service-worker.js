const CACHE_NAME = 'scriptmaker-editor-v1';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=17','../js/app.js?v=17','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
