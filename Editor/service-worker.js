const CACHE_NAME = 'scriptmaker-editor-v44';
const APP_SHELL = ['./','./index.html','./manifest.json','../css/styles.css?v=50','../js/firebase-config.js?v=30','../js/firebase-share.js?v=36','../js/app.js?v=58','../assets/icons/icon-192.png','../assets/icons/icon-512.png','../assets/images/opening-background.png'];
