const CACHE_NAME = 'scriptmaker-viewer-v6';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=6','./js/viewer.js?v=6','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
