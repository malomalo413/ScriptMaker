const CACHE_NAME = 'scriptmaker-viewer-v4';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=4','./js/viewer.js?v=4','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
