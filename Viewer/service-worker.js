const CACHE_NAME = 'scriptmaker-viewer-v13';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=13','../js/firebase-config.js?v=30','../js/firebase-share.js?v=30','./js/viewer.js?v=13','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
