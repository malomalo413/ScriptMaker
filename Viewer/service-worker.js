const CACHE_NAME = 'scriptmaker-viewer-v40';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=27','./js/firebase-config.js?v=30','./js/firebase-share.js?v=32','./js/viewer.js?v=36','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
