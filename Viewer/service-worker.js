const CACHE_NAME = 'scriptmaker-viewer-v7';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=7','./js/viewer.js?v=7','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
