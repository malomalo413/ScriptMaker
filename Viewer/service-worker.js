const CACHE_NAME = 'scriptmaker-viewer-v2';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=2','./js/viewer.js?v=2','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
