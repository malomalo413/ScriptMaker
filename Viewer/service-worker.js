const CACHE_NAME = 'scriptmaker-viewer-v3';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=3','./js/viewer.js?v=3','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
