const CACHE_NAME = 'scriptmaker-viewer-v5';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=5','./js/viewer.js?v=5','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
