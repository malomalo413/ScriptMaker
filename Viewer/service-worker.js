const CACHE_NAME = 'scriptmaker-viewer-v31';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=21','../js/firebase-config.js?v=30','../js/firebase-share.js?v=31','./js/viewer.js?v=27','../assets/icons/icon-192.png','../assets/icons/icon-512.png'];
