const CACHE_NAME = 'scriptmaker-viewer-v36';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=23','./js/firebase-config.js?v=30','./js/firebase-share.js?v=32','./js/viewer.js?v=31','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
