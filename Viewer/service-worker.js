const CACHE_NAME = 'scriptmaker-viewer-v43';
const APP_SHELL = ['./','./index.html','./manifest.json','./css/viewer.css?v=28','./js/firebase-config.js?v=30','./js/firebase-share.js?v=32','./js/viewer.js?v=39','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
